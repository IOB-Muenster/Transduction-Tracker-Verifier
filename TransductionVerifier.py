...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        description=textwrap.dedent("""\
                                    ...
                                    """),
        usage=textwrap.dedent("""python TransductionVerifier.V2.py -i <potential_transd.tsv> -r <RepeatMasker.out> -g <reference_genome.fa> -t <Alu family> -s <path/to/pslScore.pl> -c <cpu_number> 
                              """),
        epilog=textwrap.dedent("""
                               Example: python TransductionVerifier.V2.py -i alu_transd_with_pA.tsv -r RM.out -g ref_genome.fa -t AluY -s pslScore.pl -c 4
                               """
        )
        )
    ...
    print(f"{Style.BRIGHT}{Fore.YELLOW}Filtering out transductions overlapping with other TEs...")
    time.sleep(5)
    ...
    print(f"{Style.BRIGHT}{Fore.YELLOW}Initializing the alignments...")
    time.sleep(1)
    ...
    print(f"{Style.BRIGHT}{Fore.YELLOW}Preparing the inputs for the alignments...")
    time.sleep(1)
    ...
    print(f"{Style.BRIGHT}{Fore.YELLOW}The alignment step completed.")
    ...
    print(f"{Style.BRIGHT}{Fore.YELLOW}Generating the final output containing transductions whose source elements have been found...")
    time.sleep(2)
    ...
    final_blat = os.path.join(alignment_folder, "final_filtered.output.pslx")
    ...
    my_ref_genome = SeqIO.index(ref_genome, "fasta")
